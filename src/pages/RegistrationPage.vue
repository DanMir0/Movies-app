    ...
    <ma-container>
        <ma-form>
            ...
            <div class="group__blocks">
                ...
                <div class="group__input">
                    <ma-input :type="isShowPassword" v-model="password"
                              placeholder="Password" autocomplete="new-password"></ma-input>
                ...
                <div class="group__input">
                    <ma-input :type="isShowPassword" v-model="confirmPassword"
                              placeholder="Confirm password" autocomplete="confirm-password"></ma-input>
                    <span class="icon icon__password" @click="togglePasswordVisibility">
                        <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none"
                             xmlns="http://www.w3.org/2000/svg"
                             v-show="!passwordIcon">
